...
@Component({
  selector: 'app-admin-anadir-usuario',
  templateUrl: './admin-anadir-usuario.component.html',
  styleUrls: ['./admin-anadir-usuario.component.css']
})
export class AdminAnadirUsuarioComponent {
